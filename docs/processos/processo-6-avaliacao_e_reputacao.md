...
![Modelo BPMN do PROCESSO 6 - ](../images/06-diagrama-avaliação-reputação")


#### Detalhamento das atividades

1. [Acessar Resevas no Perfil Locatário](#atividade-1---acessar-reservas-no-perfil-locador)
...
3. [Descrever e avaliar  ](#atividade-1---)
   - Usuário clica em uma nota de 1 a 5 para avaliar o local
