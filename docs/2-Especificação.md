...
### 2. Dr. Carlos, o Profissional Autônomo
...
| RNF-007 | O sistema deve ser integrado com sistemas de saúde governamentais e privados | MÉDIA |
| RNF-008 | O aplicativo deve fornecer suporte técnico em tempo real para os usuários | MÉDIA |
| RNF-009 | O sistema deve ser capaz de operar com conectividade de internet variável, minimizando interrupções | MÉDIA |
| RNF-010 | O sistema deve ser acessível para usuários com diferentes necessidades (leitor de tela, alto contraste) | MÉDIA |
...
| 03 | A funcionalidade completa do aplicativo depende da conectividade à internet. |
...
| 06 | A integração com sistemas de saúde legados pode apresentar desafios técnicos. |
| 07 | A qualidade do serviço pode ser impactada pela subjetividade das avaliações dos usuários. |
