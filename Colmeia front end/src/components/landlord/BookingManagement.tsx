...
export function BookingManagement({ onBack }: BookingManagementProps) {
  ...
  const handleWhatsAppNegotiation = (booking: BookingRequest) => {
    const message = encodeURIComponent(
      `Olá ${booking.tenantName}! Sua reserva para ${booking.propertyName} no dia ${formatDate(booking.date)} foi aceita na Colmeia. Vamos negociar os detalhes do pagamento!`
    );
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-amber-900">{formatDate(booking.date)}</p>
                        </div>
                      </div>
