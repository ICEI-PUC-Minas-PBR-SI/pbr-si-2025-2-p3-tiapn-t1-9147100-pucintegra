...
module.exports = {
   ...
   */
  async buscarPorProfissional(id_profissional) {
    const sql = `
      SELECT
        a.id_agendamento,
        a.data_hora,
      ...
      LEFT JOIN pagamento pmt ON a.id_pagamento = pmt.id_pagamento
   ...
   * @param {string} status - Novo status ('aceito' ou 'rejeitado').
