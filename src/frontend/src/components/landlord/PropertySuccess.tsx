...
interface PropertySuccessProps {
  onGoToDashboard: () => void;
}

export function PropertySuccess({ onGoToDashboard }: PropertySuccessProps) {
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-amber-100 p-8 md:p-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-amber-700/70 mb-6">
            Seu imóvel foi cadastrado e já está disponível no painel de controle.
          </p>

          {/* Redirecionamento Automático */}
          <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-xl">
            <p className="text-amber-800 text-sm">
              Você será redirecionado para o painel principal em{' '}
