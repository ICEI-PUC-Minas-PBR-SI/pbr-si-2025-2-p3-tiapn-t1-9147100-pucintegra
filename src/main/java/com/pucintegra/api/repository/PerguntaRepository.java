...
public interface PerguntaRepository extends JpaRepository<Pergunta, Long> {
    ...
    void saveAnexo(@Param("idPergunta") Long idPergunta, 
    ...
    List<String> findTags(@Param("idPergunta") Long idPergunta);
}