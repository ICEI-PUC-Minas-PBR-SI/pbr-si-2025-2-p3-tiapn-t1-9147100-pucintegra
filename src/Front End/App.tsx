...
export default function App() {
  ...
  const [currentFlow, setCurrentFlow] = useState<
    'signup' | 'login' | 'dashboard' | 'property' | 'bookings' | 'availability' | 'pricing' | 'reports' | 'landlord-ratings' |
    'tenant-login' | 'tenant-listing' | 'tenant-booking' | 'tenant-booking-success' | 'tenant-reservations' | 'tenant-rating-success' |
